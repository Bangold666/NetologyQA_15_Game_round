...
public class GameTest {
    ...
    void shouldRegisterManyPlayers() {
        ...
        Player player2 = new Player(2, "Vanya", 15);
    ...
    void shouldRoundRegisteredPlayers() {
        ...
        int actual = players.round("Sergey", "Vanya");
        int expected = 1;
        ...
        int actual2 = players.round("Vanya", "Alina");
        int expected2 = 0;
    ...
    void shouldRoundNotRegisteredPlayers() {
        ...
        Assertions.assertThrows(NotRegisteredException.class, () -> {
            players.round("John", "Sergey"); // John = null, Sergey = 20
        });

        Assertions.assertThrows(NotRegisteredException.class, () -> {
            players.round("Ivan", "Loki"); // Ivan = 2, Loki = null
        });

        Assertions.assertThrows(NotRegisteredException.class, () -> {
            players.round("John", "Loki"); // John = null, Loki = null
        });
